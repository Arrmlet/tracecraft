...
class StorageConfig(BaseModel):
    ...
    bucket_name: str = Field(default="tracecraft-data", description="Default storage bucket")
...
class UIConfig(BaseModel):
    ...
    port: int = Field(default=8000, description="UI server port")
...
class DatabaseConfig(BaseModel):
    ...
    database: str = Field(default="tracecraft", description="Database name")
    user: str = Field(default="tracecraft", description="Database user")
    password: str = Field(default="tracecraft", description="Database password")
...
class TracecraftConfig(BaseModel):
    """Main configuration model for tracecraft."""
...
class ConfigManager:
    """
    Configuration manager for tracecraft.
    ...
    def _load_config(self) -> TracecraftConfig:
        ...
        return TracecraftConfig(**config_dict)
    ...
    def get_config(self) -> TracecraftConfig:
    ...
    def validate_config(self) -> bool:
        ...
        try:
            ...
            TracecraftConfig(**self.config.dict())
            return True
        except Exception as e:
